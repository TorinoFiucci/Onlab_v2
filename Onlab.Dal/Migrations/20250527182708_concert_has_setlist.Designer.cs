...
namespace Onlab.Dal.Migrations
{
    ...
    [Migration("20250527182708_concert_has_setlist")]
    partial class concert_has_setlist
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Onlab.Dal.Entities.Setlist", b =>
                {
                    ...
                    b.HasIndex("ConcertId")
                        .IsUnique()
                        .HasFilter("[ConcertId] IS NOT NULL");
            ...
            modelBuilder.Entity("Onlab.Dal.Entities.Setlist", b =>
                {
                    ...
                    b.HasOne("Onlab.Dal.Entities.Concert", "Concert")
                        .WithOne("Setlist")
                        .HasForeignKey("Onlab.Dal.Entities.Setlist", "ConcertId");
